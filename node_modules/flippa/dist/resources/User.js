...
var User = (function (_Resource) {
  ...
  function User(client, userId) {
    _classCallCheck(this, User);

    _get(Object.getPrototypeOf(User.prototype), 'constructor', this).call(this, client);
    this.userId = userId;
  }
  ...
  _createClass(User, [{
    ...
    key: 'listSavedSearches',
    value: function listSavedSearches() {
      return this.client.get('/users/' + this.userId + '/saved-searches');
    }
  }, {
    key: 'listAlerts',
    value: function listAlerts() {
      return this.client.get('/users/' + this.userId + '/alerts');
    }
  }, {
    key: 'createWatchedItem',
    value: function createWatchedItem() {
