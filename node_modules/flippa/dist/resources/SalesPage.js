...
var SalesPage = (function (_Resource) {
  _inherits(SalesPage, _Resource);

  function SalesPage(client, salesPageId) {
    _classCallCheck(this, SalesPage);

    _get(Object.getPrototypeOf(SalesPage.prototype), 'constructor', this).call(this, client);
